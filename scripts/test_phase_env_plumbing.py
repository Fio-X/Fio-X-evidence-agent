#!/usr/bin/env python3
"""Verify Rust Pi launch forwards only validated opt-in phase values."""
import json
import os
import subprocess
import tempfile
...
import json, os, sys
with open(os.environ["PHASE_CAPTURE"], "w", encoding="utf-8") as handle:
    json.dump({"phase": os.environ.get("NEWSROOM_PHASE")}, handle)
