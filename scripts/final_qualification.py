...
def main() -> None:
    ...
    out={'schema_version':'0.4.0','release':'1.13.0-rc1','status':'PASS' if not blockers else 'BLOCKED','checks':checks,'blockers':blockers,'evidence':evidence_paths,'evidence_index':evidence_index,'evidence_set_sha256':evidence_set_hash(evidence_index)}
