...
export const DEFAULT_REFERENCE_PATTERNS = [
  { id:'scmp-integrated-explainer', publication:'South China Morning Post', tags:['spatial','mechanism','scene','illustration','map'], transferable_principle:'Use the subject itself as the spatial scaffold and attach evidence directly to it.', differentiation_rule:'Change the premise, geometry and asset mix to fit the current reported subject; do not reproduce SCMP artwork or typography.', source_url:'https://multimedia.scmp.com/infographics/', copy_risk:'low' },
  ...
  { id:'pudding-kill-weak-ideas', publication:'The Pudding', tags:['discovery','concept','research','restart'], transferable_principle:'Explore, pivot and kill weak premises before committing production effort.', differentiation_rule:'Use the editorial decision pattern, not any published visual identity.', source_url:'https://pudding.cool/process/', copy_risk:'low' },
